...
4. **Download Project Files**: Clone or download the project files, **along with NirCmd**, into `C:\Scripts\speech2input\` or a directory of your choosing.
  > [!TIP]
...
5. **Install Push2Run**: Download and install the [Push2Run](https://www.push2run.com/) application on your Windows PC.
